...
// Layout dọc: Header (ngày + tag) → Tiêu đề → Ảnh + nút "Đọc ngay".
//
...
interface ArticleCardProps {
  ...
  category?: string;    // Nhóm lớn — hiện luôn là "TIN TỨC" (hiển thị màu cam)
...
const ArticleCard: React.FC<ArticleCardProps> = ({
  ...
  return (
    ...
    <article className="group flex flex-col w-full bg-white pr-[30px] pl-[60px] py-[40px] border-b">
      ...
      {/* Tag nhóm: "TIN TỨC / RỦI RO" — category màu cam, subCategory màu đen */}
